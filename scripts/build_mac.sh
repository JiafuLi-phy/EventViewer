...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 2.0.3" "$PLIST" 2>/dev/null || \
  /usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 2.0.3" "$PLIST"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 2.0.3" "$PLIST" 2>/dev/null || \
  /usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 2.0.3" "$PLIST"
